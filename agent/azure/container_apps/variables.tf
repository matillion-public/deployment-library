...
variable "workload_profile_type" {
  type        = string
  description = "Override the workload profile type derived from agent_size. xlarge requires at least D8."
  default     = null
}
...
variable "container_cpu" {
  type        = string
  description = "Override the CPU allocation derived from agent_size."
  default     = null
}

variable "container_memory" {
  type        = string
  description = "Override the memory allocation derived from agent_size (e.g. \"4Gi\")."
  default     = null
}
